...
namespace LegalAssistant.Infrastructure.Db.Migrations
{
    ...
    [Migration("20260906184850_AddWorkerIdempotency")]
    partial class AddWorkerIdempotency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegalAssistant.Domain.Models.DocumentChunk", b =>
                {
                    ...
                    b.HasIndex("ChunkingRunId", "ChunkIndex")
                        .IsUnique()
            ...
            modelBuilder.Entity("LegalAssistant.Domain.Models.OutboxMessageRecord", b =>
                {
                    ...
                    b.Property<long?>("AskJobEventId")
                        .HasColumnType("bigint")
                        .HasColumnName("ask_job_event_id");
                    ...
                    b.HasIndex("AskJobEventId");

                    b.HasIndex("JobId", "MessageType");

                    b.HasIndex("MessageType", "DeduplicationKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("LegalAssistant.Infrastructure.Db.Models.DocumentChunkVectorSearchRow", b =>
                {
                    b.Property<string>("CharRange")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.ToView("document_chunks", (string)null);
                });
            ...
            modelBuilder.Entity("LegalAssistant.Domain.Models.OutboxMessageRecord", b =>
                {
                    b.HasOne("LegalAssistant.Domain.Models.AskJobEventRecord", "AskJobEvent")
                        .WithMany()
                        .HasForeignKey("AskJobEventId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AskJobEvent");
                });
