...
namespace LegalAssistant.Api.Services
{
    ...
    public class DocumentService : IDocumentService
    {
        ...
        public DocumentService(LegalAssistantDbContext db, IMessagePublisher publisher)
        {
            _db = db;
        ...
        {
            return await _db.Documents.Include(d => d.Chunks).FirstOrDefaultAsync(d => d.Id == id && !d.IsDeleted);
        }
